...
#include "DSP2834x_Device.h"     // DSP28 Header-file Include File
...
/* Configure bit timing parameters for eCANB*/
    ...
    #if (CPU_FRQ_300MHZ)                       // CPU_FRQ_300MHz is defined in DSP2834x_Examples.h
	/* The following block for all 300 MHz SYSCLKOUT (75 MHz CAN clock) - default. Bit rate = 50Kbps
	   See Note at end of file. 
		ECanbShadow.CANBTC.bit.BRPREG = 99;
		ECanbShadow.CANBTC.bit.TSEG2REG = 3;
		ECanbShadow.CANBTC.bit.TSEG1REG = 9;   */
	/* The following block for all 300 MHz SYSCLKOUT (75 MHz CAN clock) - default. Bit rate = 250Kbps
	   See Note at end of file. */
