...
void InitXintf(void)
{
    ...
    XintfRegs.XTIMING6.bit.X2TIMING = 1;								//XintfRegs.XTIMING6.bit.X2TIMING = 1;							
																		//																
    // Zone will sample XREADY signal									//// Zone will sample XREADY signal								
    XintfRegs.XTIMING6.bit.USEREADY = 1;								//XintfRegs.XTIMING6.bit.USEREADY = 1;							
    XintfRegs.XTIMING6.bit.READYMODE = 1;  // sample asynchronous		//XintfRegs.XTIMING6.bit.READYMODE = 1;  // sample asynchronous	
